# Top 20 opportunities (free route, pass-1 evidence)
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `cpu motherboard compatibility list`; `best cpu compatible with my motherboard`; `best motherboard for cpu`; `can any cpu work with any motherboard`; `cpu and motherboard compatibility calculator`; `cpu motherboard compatible alternatives`; `cpu motherboard compatible cheaper one`; `cpu motherboard compatible compatibility best`
...
**4. Aggregate cluster demand (measured, pass 1).** 25 member queries, 12 with task intent (0.48 share), 3 of them volunteered by the engines on bare probes; intent mix informational 13, decide 3, find 2, alternative 2; subdomains touched: compatibility. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best gaming pc for modded minecraft`; `how to get modded games on pc`; `how to play modded games on pc`; `best free modded games for pc`; `best pc for modding`; `best pc for modding and gaming`; `how to get modded games on iphone`; `how to get modded mobile games on pc`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `what's the best settings in rivals`; `best rivals settings new update`; `best settings for rivals`; `best settings for rivals roblox controller`; `best settings for rivals roblox mobile`; `rivals best settings code`; `rivals best settings ps5`; `what's the best settings in roblox rivals`
...
**4. Aggregate cluster demand (measured, pass 1).** 35 member queries, 35 with task intent (1.0 share), 4 of them volunteered by the engines on bare probes; intent mix decide 34, how_to 1; subdomains touched: settings. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best stl files for 3d printing`; `how to design stl files for 3d printing`; `how to repair stl files for 3d printing`; `where to find stl files for 3d printing`; `best stl files for 3d printing free`; `does stl files work with 3d printing`; `how many stl files for 3d printing`; `how much stl files for 3d printing`
...
**4. Aggregate cluster demand (measured, pass 1).** 30 member queries, 18 with task intent (0.6 share), 4 of them volunteered by the engines on bare probes; intent mix informational 10, how_to 5, decide 2, calculate 2; subdomains touched: models. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to move abroad`; `how to move abroad as an american`; `how to move abroad from india`; `how to move abroad from uk`; `how to move abroad with no money`; `best jobs to move abroad`; `best jobs to move abroad reddit`; `best place for americans to move abroad`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to play warhammer 40k 11th edition`; `how to play warhammer 40k 10th edition`; `warhammer 40k 11th edition changes`; `warhammer 40k list builder 10th edition`; `warhammer 40k 10th edition changes`; `warhammer 40k 10th edition datasheet template`; `warhammer 40k 10th edition points changes`; `warhammer 40k 10th edition rules changes`
...
**4. Aggregate cluster demand (measured, pass 1).** 30 member queries, 17 with task intent (0.57 share), 5 of them volunteered by the engines on bare probes; intent mix informational 13, track 8, find 3, how_to 2; subdomains touched: miniatures_warhammer. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to format for kdp publishing`; `alternative to kdp publishing`; `best software for kdp publishing`; `how much does it cost to publish with kdp`; `how much is kdp publishing`; `how to format a book for kdp publishing`; `how to format kdp self published books`; `how to publish a book free with kdp`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to read obd2 codes`; `obd2 codes list`; `obd2 codes list pdf`; `obd2 scanner codes list`; `how to check obd2 codes without a scanner`; `how to clear obd2 codes`; `how to reset obd2 codes`; `obd2 codes list free`
...
**4. Aggregate cluster demand (measured, pass 1).** 56 member queries, 42 with task intent (0.75 share), 5 of them volunteered by the engines on bare probes; intent mix how_to 19, informational 10, find 10, commercial_nav 4; subdomains touched: diagnostics. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best garden pruning tools`; `best garden pruning`; `best gardening services for fall pruning`; `best gardening services for pruning`; `best gardening services for pruning tomatoes`; `best gardening services for winter pruning`; `garden pruning alternatives`; `garden pruning free alternatives`

**3. Search-volume evidence.** None measured on the free route. Relative signals only: head term 'garden pruning' at 1.1 on the chained Trends scale (root = 100, rounding error ±3.9%); 6 of 42 members were suggested by two or more engines.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `unity build error`; `unity build not working`; `fix unity build error`; `fix unity build not working`; `fix unity builds`; `how much unity building`; `how to build unity 6`; `unity best build`
...
**4. Aggregate cluster demand (measured, pass 1).** 33 member queries, 19 with task intent (0.58 share), 3 of them volunteered by the engines on bare probes; intent mix informational 13, fix 6, optimize 3, calculate 2; subdomains touched: unity. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best settings for rocket league`; `best settings for beginners in rocket league`; `best settings for pc rocket league`; `best settings for rocket league keyboard and mouse`; `best settings for rocket league nintendo switch`; `best settings for rocket league ps4`; `best settings for rocket league xbox`; `controller not working on rocket league pc`
...
**4. Aggregate cluster demand (measured, pass 1).** 31 member queries, 29 with task intent (0.94 share), 4 of them volunteered by the engines on bare probes; intent mix decide 22, fix 7, informational 2; subdomains touched: peripherals, settings. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `export settings for youtube video`; `export settings youtube`; `best export settings for youtube long video`; `best export settings for youtube videos`; `best export settings youtube`; `export settings for youtube reddit`; `export settings youtube alternatives`; `export settings youtube cheaper alternative`
...
**4. Aggregate cluster demand (measured, pass 1).** 21 member queries, 21 with task intent (1.0 share), 4 of them volunteered by the engines on bare probes; intent mix convert 10, decide 3, alternative 3, calculate 3; subdomains touched: codecs_export. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best emulator for pc games reddit`; `best gaming emulator for pc free`; `best pc games without emulator`; `best pc gaming emulator`; `fix pc gaming emulators`; `how many pc gaming emulators`; `how much pc gaming emulator do i need`; `pc gaming emulator alternative free`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best stain for wood furniture`; `how to apply wood stain on deck`; `how to apply wood stain with a brush`; `how to properly apply stain to wood`; `how to properly stain wood`; `how to remove wood stain from wood`; `how to wood stain a door`; `how to wood stain a table`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `cities skylines 1 vs 2`; `cities skylines 2 alternative`; `cities skylines 2 not working`; `cities skylines 2 slow`; `cities skylines 2 update`; `cities skylines alternatives`; `cities skylines error`; `cities skylines not working`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `renovation cost per square foot`; `house cleaning cost per square foot`; `renovation cost per square foot ontario`; `renovation costs per square foot uk`; `average cost of renovation per square foot`; `average home renovation cost per square foot`; `average renovation cost per sq ft`; `bath renovation cost per square foot`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best pet birds for beginners`; `best pet birds for beginners in india`; `best pet birds for kids`; `how to pet bird`; `which pet bird is best for home`; `best pet birds`; `best pet birds for beginners and kids`; `best pet birds for beginners reddit`

**3. Search-volume evidence.** None measured on the free route. Relative signals only: head term 'pet bird care' at 0.4 on the chained Trends scale (root = 100, rounding error ±39.6%); 9 of 42 members were suggested by two or more engines.

**4. Aggregate cluster demand (measured, pass 1).** 42 member queries, 26 with task intent (0.62 share), 3 of them volunteered by the engines on bare probes; intent mix decide 13, informational 13, calculate 4, find 4; subdomains touched: birds_small_pets. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to stop a metal roof from leaking`; `how to find where roof is leaking`; `how to fix a leaking flat roof`; `how to fix a leaking metal roof`; `how to fix leaking roof from inside`; `how to repair a leaking flat roof`; `how to repair leaking roof`; `how to stop a concrete roof from leaking`
...
**4. Aggregate cluster demand (measured, pass 1).** 77 member queries, 36 with task intent (0.47 share), 5 of them volunteered by the engines on bare probes; intent mix informational 41, how_to 14, fix 11, calculate 4; subdomains touched: roof_exterior. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `how to render animation in houdini`; `how to render in houdini`; `how to render in houdini karma`; `how to render video in houdini`; `houdini fbx character import`; `houdini import fbx animation`; `houdini karma render tutorial`; `how to export animation in houdini`
...
**4. Aggregate cluster demand (measured, pass 1).** 26 member queries, 21 with task intent (0.81 share), 5 of them volunteered by the engines on bare probes; intent mix how_to 18, informational 5, convert 3; subdomains touched: vfx_sim. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `best office software zapier integration`; `generate office software zapier integration`; `how to create a zapier integration`; `identify office software zapier integration`; `improve office software zapier integration`; `list of zapier integrations`; `office software zapier database integration`; `office software zapier performance integration`
...
**4. Aggregate cluster demand (measured, pass 1).** 22 member queries, 12 with task intent (0.55 share), 5 of them volunteered by the engines on bare probes; intent mix informational 9, decide 2, generate 2, how_to 2; subdomains touched: automation. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `does notion work with microsoft`; `microsoft app similar to notion`; `does notion work with microsoft 365`; `is there a microsoft alternative to notion`; `is there a microsoft app like notion`; `microsoft alternative to notion`; `microsoft alternative to notion free`; `microsoft loop similar to notion`

**3. Search-volume evidence.** None measured on the free route. Relative signals only: head term placed at ~0 but with ±100.0% error, so unreliable; 3 of 31 members were suggested by two or more engines.

**4. Aggregate cluster demand (measured, pass 1).** 31 member queries, 19 with task intent (0.61 share), 10 of them volunteered by the engines on bare probes; intent mix alternative 15, informational 12, compatibility 2, how_to 1; subdomains touched: notes_pkm. Member counts reflect one seed per subdomain and will change in later passes.
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `door won't close`; `door won't close all the way`; `door won't close at top`; `how to fix door that won't close all the way`; `best door won't close all the way`; `door won't close all the way reddit`; `door won't close cheaper way`; `door won't close free alternatives`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `printer offline error`; `printer offline issue`; `printer offline problem`; `best offline printer`; `fix printer offline issue`; `printer offline fix`; `printer offline problem how to fix`; `best printer offline to online`
...
**2. Representative searches (measured; most-corroborated task-intent members first).** `good performance review comments`; `performance review comments`; `performance review comments for employees`; `performance review examples for employees`; `performance review problem solving comments`; `performance review template for employees`; `performance reviews for employees`; `ai performance review generator for employees`
...
**4. Aggregate cluster demand (measured, pass 1).** 30 member queries, 30 with task intent (1.0 share), 5 of them volunteered by the engines on bare probes; intent mix optimize 20, generate 5, decide 1, how_to 1; subdomains touched: monitors, workplace. Member counts reflect one seed per subdomain and will change in later passes.
