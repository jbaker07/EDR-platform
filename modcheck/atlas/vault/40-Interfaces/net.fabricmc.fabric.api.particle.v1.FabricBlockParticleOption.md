---
type: "interface"
fqcn: "net.fabricmc.fabric.api.particle.v1.FabricBlockParticleOption"
...
```java
public static net.minecraft.core.particles.BlockParticleOption create(net.minecraft.core.particles.ParticleType, net.minecraft.world.level.block.state.BlockState, net.minecraft.core.BlockPos)
