---
type: "interface"
fqcn: "net.fabricmc.fabric.api.client.message.v1.ClientSendMessageEvents"
...
public static final net.fabricmc.fabric.api.event.Event ALLOW_COMMAND
public static final net.fabricmc.fabric.api.event.Event MODIFY_CHAT
public static final net.fabricmc.fabric.api.event.Event MODIFY_COMMAND
public static final net.fabricmc.fabric.api.event.Event CHAT
public static final net.fabricmc.fabric.api.event.Event COMMAND
public static final net.fabricmc.fabric.api.event.Event CHAT_CANCELED
public static final net.fabricmc.fabric.api.event.Event COMMAND_CANCELED
```
