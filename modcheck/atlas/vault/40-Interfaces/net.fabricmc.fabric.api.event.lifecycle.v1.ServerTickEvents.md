---
type: "interface"
fqcn: "net.fabricmc.fabric.api.event.lifecycle.v1.ServerTickEvents"
...
```java
public static final net.fabricmc.fabric.api.event.Event START_SERVER_TICK
public static final net.fabricmc.fabric.api.event.Event END_SERVER_TICK
