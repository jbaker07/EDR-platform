...
|---|---|---|---|---|---|---|---|
| calls | `<init>` | `()V` | exact | invokespecial@4 in `PictureInPictureRendererRegistryImpl.lambda$registerVanillaFactories$2 | unknown | [[30-Mechanisms/fabric-rendering-v1|fabric-rendering-v1]] | direct_reference |
...
protected renderToTexture(Lnet/minecraft/client/renderer/state/gui/pip/GuiBookModelRenderState;Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/SubmitNodeCollector;)V
