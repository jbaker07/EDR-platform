...
```java
public static boolean registerGlobalReceiver(net.minecraft.network.protocol.common.custom.CustomPacketPayload$Type, net.fabricmc.fabric.api.networking.v1.ServerConfigurationNetworking$ConfigurationPacketHandler)
...
public static boolean registerReceiver(net.minecraft.server.network.ServerConfigurationPacketListenerImpl, net.minecraft.network.protocol.common.custom.CustomPacketPayload$Type, net.fabricmc.fabric.api.networking.v1.ServerConfigurationNetworking$ConfigurationPacketHandler)
...
public static java.util.Set getReceived(net.minecraft.server.network.ServerConfigurationPacketListenerImpl)
public static java.util.Set getSendable(net.minecraft.server.network.ServerConfigurationPacketListenerImpl)
