---
type: "interface"
fqcn: "net.fabricmc.fabric.api.client.rendering.v1.EntityRendererRegistry"
...
```java
public static void register(net.minecraft.world.entity.EntityType, net.minecraft.client.renderer.entity.EntityRendererProvider)
```
