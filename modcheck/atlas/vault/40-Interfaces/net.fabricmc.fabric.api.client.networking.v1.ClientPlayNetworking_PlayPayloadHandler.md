---
type: "interface"
fqcn: "net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking$PlayPayloadHandler"
...
```java
public abstract void receive(net.minecraft.network.protocol.common.custom.CustomPacketPayload, net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking$Context)
```
