...
public abstract java.util.Optional getOptional(net.minecraft.resources.ResourceKey)
public abstract void registerEntryAdded(net.minecraft.resources.ResourceKey, net.fabricmc.fabric.api.event.registry.RegistryEntryAddedCallback)
```
