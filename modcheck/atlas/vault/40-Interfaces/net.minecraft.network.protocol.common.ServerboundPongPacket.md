...
|---|---|---|---|---|---|---|---|
| calls | `getId` | `()I` | exact | invokevirtual@22 in `ServerCommonPacketListenerImplMixin.onPlayPong` | unknown | [[30-Mechanisms/fabric-networking-api-v1|fabric-networking-api-v1]] | direct_reference |
