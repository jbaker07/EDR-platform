...
```java
public <init>(net.fabricmc.fabric.api.datagen.v1.FabricPackOutput, net.minecraft.resources.ResourceKey, java.util.concurrent.CompletableFuture)
...
protected net.fabricmc.fabric.api.datagen.v1.provider.FabricTagsProvider$AliasGroupBuilder aliasGroup(net.minecraft.resources.Identifier)
protected net.fabricmc.fabric.api.datagen.v1.provider.FabricTagsProvider$AliasGroupBuilder aliasGroup(java.lang.String)
public java.util.Map getAliasGroupBuilders()
```
