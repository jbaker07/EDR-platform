...
```java
public static com.mojang.brigadier.CommandDispatcher getActiveDispatcher()
public static void refreshCommandCompletions()
public static com.mojang.brigadier.builder.LiteralArgumentBuilder literal(java.lang.String)
public static com.mojang.brigadier.builder.RequiredArgumentBuilder argument(java.lang.String, com.mojang.brigadier.arguments.ArgumentType)
```
