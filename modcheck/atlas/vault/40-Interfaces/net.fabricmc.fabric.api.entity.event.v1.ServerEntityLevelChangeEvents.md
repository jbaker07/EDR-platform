...
```java
public static final net.fabricmc.fabric.api.event.Event AFTER_ENTITY_CHANGE_LEVEL
public static final net.fabricmc.fabric.api.event.Event AFTER_PLAYER_CHANGE_LEVEL
```
