...
public net.fabricmc.loader.api.metadata.version.VersionInterval and(net.fabricmc.loader.api.metadata.version.VersionInterval)
public java.util.List or(java.util.Collection)
public java.util.List not()
...
public static java.util.List and(java.util.Collection, java.util.Collection)
public static java.util.List or(java.util.Collection, net.fabricmc.loader.api.metadata.version.VersionInterval)
public static java.util.List not(net.fabricmc.loader.api.metadata.version.VersionInterval)
public static java.util.List not(java.util.Collection)
```
