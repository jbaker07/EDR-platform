...
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView pos(int, org.joml.Vector3f)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView pos(int, org.joml.Vector3fc)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView translate(float, float, float)
public abstract net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView color(int, int)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView color(int, int, int, int)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView multiplyColor(int)
public abstract net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView uv(int, float, float)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView uv(int, org.joml.Vector2f)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView uv(int, org.joml.Vector2fc)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView uvUnitSquare()
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView materialBake(net.minecraft.client.resources.model.sprite.Material$Baked, int)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView postMaterialBake(net.minecraft.client.resources.model.sprite.Material$Baked)
public abstract net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView lightmap(int, int)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView lightmap(int, int, int, int)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView minLightmap(int)
public abstract net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView normal(int, float, float, float)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView normal(int, org.joml.Vector3f)
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView normal(int, org.joml.Vector3fc)
...
public net.fabricmc.fabric.api.client.renderer.v1.mesh.MutableQuadView square(net.minecraft.core.Direction, float, float, float, float, float)
```
