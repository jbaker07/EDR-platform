...
|---|---|---|---|---|---|---|---|
| calls | `<init>` | `(Lnet/minecraft/world/InteractionHand;IFF)V` | exact | invokespecial@14 in `MultiPlayerGameModeMixin.lambda$interactItem$0` | unknown | [[30-Mechanisms/fabric-events-interaction-v0|fabric-events-interaction-v0]] | direct_reference |
...
private final yRot : F
private final xRot : F
public static final STREAM_CODEC : Lnet/minecraft/network/codec/StreamCodec;
public <init>(Lnet/minecraft/world/InteractionHand;IFF)V
