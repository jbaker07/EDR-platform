---
type: "interface"
fqcn: "net.fabricmc.fabric.api.networking.v1.ServerConfigurationNetworking$ConfigurationPacketHandler"
...
```java
public abstract void receive(net.minecraft.network.protocol.common.custom.CustomPacketPayload, net.fabricmc.fabric.api.networking.v1.ServerConfigurationNetworking$Context)
```
