...
|---|---|---|---|
| `ServerPlayerGameModeMixin.onBlockBroken` | `ServerPlayerGameMode.destroyBlock` @Inject at INVOKE Lnet/minecraft/world/level/block/Block;destroy(Lnet/minecraft/world/level/LevelAccessor;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/state/BlockState;)V | both | static_inference |
