---
type: "event"
event: "net.fabricmc.fabric.api.message.v1.ServerMessageEvents.CHAT_MESSAGE"
callback: "net.fabricmc.fabric.api.message.v1.ServerMessageEvents$ChatMessage"
---

> [!info] Generated
> Built by `atlas/extract/vault.py` from the records and extracted facts it links to. Do not edit; edit the source and regenerate.

# net.fabricmc.fabric.api.message.v1.ServerMessageEvents.CHAT_MESSAGE

Callback interface: `net.fabricmc.fabric.api.message.v1.ServerMessageEvents$ChatMessage`
