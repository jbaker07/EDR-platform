...
|---|---|---|---|
| `PlayerListMixin.onSendCommandMessage` @12 | [[40-Interfaces/net.minecraft.server.players.PlayerList|PlayerList]].`broadcastChatMessage` @Inject HEAD | unknown | static_inference |
