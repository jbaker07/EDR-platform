...
|---|---|---|---|
| `ClientPacketListenerMixin.fabric_allowSendChatMessage` @99 | [[40-Interfaces/net.minecraft.client.multiplayer.ClientPacketListener|ClientPacketListener]].`sendChat` @Inject HEAD | unknown | static_inference |
