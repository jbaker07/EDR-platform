...
|---|---|---|---|
| `BlockBehaviourBlockStateBaseMixin.callUseItemOnEvent` @25 | [[40-Interfaces/net.minecraft.world.level.block.state.BlockBehaviour_BlockStateBase|BlockBehaviour$BlockStateBase]].`useItemOn` @Inject HEAD | unknown | static_inference |
