...
|---|---|---|---|
| `ServerEntityMixin.onStartTracking` @14 | [[40-Interfaces/net.minecraft.server.level.ServerEntity|ServerEntity]].`addPairing` @Inject TAIL | unknown | static_inference |
