...
|---|---|---|---|
| `ServerLevelEntityCallbacksMixin.invokeEntityLoadEvent` | `ServerLevel$EntityCallbacks.onTrackingStart(Lnet/minecraft/world/entity/Entity;)V` @Inject at TAIL | both | static_inference |
