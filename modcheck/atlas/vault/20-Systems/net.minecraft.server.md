...
52 classes in the jar. Hooked types: 12

- [[40-Interfaces/net.minecraft.server.Bootstrap|Bootstrap]] -- injects_into:1, wraps:1 -- by fabric-registry-sync-v0
- [[40-Interfaces/net.minecraft.server.Main|Main]] -- calls:1, injects_into:4 -- by fabric-client-gametest-api-v1, fabric-data-generation-api-v1, fabric-gametest-api-v1, fabric-registry-sync-v0
- [[40-Interfaces/net.minecraft.server.MinecraftServer|MinecraftServer]] -- calls:30, injects_into:19, wraps:1 -- by fabric-api-lookup-api-v1, fabric-biome-api-v1, fabric-client-gametest-api-v1, fabric-convention-tags-v2, fabric-data-attachment-api-v1, fabric-dimensions-v1, fabric-game-rule-api-v1, fabric-gametest-api-v1, fabric-lifecycle-events-v1, fabric-loot-api-v3, fabric-message-api-v1, fabric-networking-api-v1, fabric-registry-sync-v0, fabric-resource-loader-v1
- [[40-Interfaces/net.minecraft.server.MinecraftServer_ReloadableResources|MinecraftServer$ReloadableResources]] -- calls:2 -- by fabric-lifecycle-events-v1, fabric-resource-loader-v1
- [[40-Interfaces/net.minecraft.server.PlayerAdvancements|PlayerAdvancements]] -- injects_into:2 -- by fabric-events-interaction-v0
- [[40-Interfaces/net.minecraft.server.RegistryLayer|RegistryLayer]] -- reads:2 -- by fabric-tag-api-v1
- [[40-Interfaces/net.minecraft.server.ReloadableServerRegistries|ReloadableServerRegistries]] -- wraps:1 -- by fabric-registry-sync-v0
