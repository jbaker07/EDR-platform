...
# torch / torch_geometric are heavy, optional deps. Guard them so this utils
# package imports without them (graph_archiver here is torch-free). load_model()
# raises clearly if the GNN stack is genuinely needed but absent.
try:
    import torch
